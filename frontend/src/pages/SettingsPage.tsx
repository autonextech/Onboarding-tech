    ...
    <div className="min-h-full px-4 py-6 sm:px-6 lg:px-10 max-w-3xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center gap-3 mb-6 sm:mb-8">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-extrabold" style={{ color: '#0F172A', fontFamily: "'Instrument Sans', sans-serif" }}>Settings</h2>
            <p className="text-sm" style={{ color: '#64748B' }}>Manage your account preferences</p>
          </div>
        </div>
      </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <div className="glass-card p-5 sm:p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-lg font-bold" style={{ color: '#0F172A', fontFamily: "'Instrument Sans', sans-serif" }}>Profile Information</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="email" defaultValue={userEmail} className="w-full px-4 py-2.5 rounded-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 bg-white transition-all" style={{ color: '#0F172A' }} />
              </div>
              <div>
                <label className="block text-xs font-medium mb-1" style={{ color: '#64748B' }}>Role</label>
                <input type="text" value={userRole === 'admin' ? 'Administrator' : 'Candidate'} readOnly className="w-full px-4 py-2.5 rounded-lg border border-slate-200 text-sm bg-slate-50" style={{ color: '#64748B' }} />
              </div>
              <div>
                <label className="block text-xs font-medium mb-1" style={{ color: '#64748B' }}>Department</label>
                <input type="text" defaultValue="Engineering" className="w-full px-4 py-2.5 rounded-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 bg-white transition-all" style={{ color: '#0F172A' }} />
              </div>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <div className="glass-card p-5 sm:p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-lg font-bold" style={{ color: '#0F172A', fontFamily: "'Instrument Sans', sans-serif" }}>Notification Preferences</h3>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <div className="glass-card p-5 sm:p-6">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-lg font-bold" style={{ color: '#0F172A', fontFamily: "'Instrument Sans', sans-serif" }}>Security</h3>
            </div>
            <button className="px-5 py-2 rounded-lg text-sm font-semibold border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer" style={{ color: '#0F172A' }}>
              Change Password
            </button>
          </div>
        </motion.div>
